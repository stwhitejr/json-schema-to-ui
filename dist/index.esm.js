...
// @ts-ignore
var JsonToUiContext = createContext({});
var useJsonToUiContext = function () {
    return useContext(JsonToUiContext);
};
...
var JsonToUiSwitch = function (props) {
    ...
    if (CustomComponent) {
        return jsx(CustomComponent, __assign({}, props));
    }
    ...
    switch (valueType) {
        case 'object': {
            ...
            jsx(componentByTypeMapping.object, __assign({}, props, { children: jsx(JsonToUiTraverse, __assign({}, props)) })));
        }
        case 'array': {
            return (
            // @ts-ignore we know the value type
            jsx(componentByTypeMapping.array, __assign({}, props, { children: jsx(JsonToUiTraverse, __assign({ isArray: true, Wrapper: componentByTypeMapping.arrayItem }, props)) })));
        }
        default: {
...
var JsonToUiTraverse = function (_a) {
    ...
    return (jsx(Fragment, { children: children.map(function (_a) {
            var _b, _c, _d;
            ...
            var content = jsx(JsonToUiSwitch, __assign({}, contentProps), path);
            if (Wrapper) {
                return (jsx(Wrapper, __assign({}, contentProps, { children: content }), path));
            }
            return content;
        }) }));
};
...
var JsonToUi = function (props) {
    return (jsx(JsonToUiContext.Provider, { value: props, children: jsx(JsonToUiTraverse, { path: "", schema: props.schema, value: props.value }) }));
};

export { JsonToUi as default };
